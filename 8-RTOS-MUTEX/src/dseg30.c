...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1, .adv_w = 0, .box_w = 3, .box_h = 4, .ofs_x = -2, .ofs_y = 0},
    {.bitmap_index = 3, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 75, .adv_w = 392, .box_w = 3, .box_h = 29, .ofs_x = 19, .ofs_y = 1},
    {.bitmap_index = 86, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 158, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 230, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 302, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 374, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 446, .adv_w = 392, .box_w = 19, .box_h = 29, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 515, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 587, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 659, .adv_w = 96, .box_w = 3, .box_h = 16, .ofs_x = 1, .ofs_y = 7}};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
    {
        {.range_start = 32, .range_length = 15, .glyph_id_start = 1, .unicode_list = unicode_list_0, .glyph_id_ofs_list = NULL, .list_length = 2, .type = LV_FONT_FMT_TXT_CMAP_SPARSE_TINY},
